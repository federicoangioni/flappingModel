...
exp_title='FIG4 combined3';
NEXP=[76 77 78 79];
legend_list={'15, Yaw=0','15, Yaw=max','45, Yaw=0','45, Yaw=max'};
cmdROLL=[862 862 2357 2357];
cmdPITCH=[7401 7401 5418 5418];
...
%     polarplot([psiOM(:,TIME==0.25)'; psiOM(:,TIME==0.25)'], [zeros(size(OM(:,TIME==0.25)')); OM(:,TIME==0.25)'],'Color',colors(i,:))
    ...
    title('Rotation axis - to be pasted to panels A-D')
    %     rlim([0 150])
