...
function transformer_sequence_non_constant(posx,posy,posz,roll,pitch,yaw,dihedrL,dihedrR,cmd_motor_left,cmd_motor_right,cmd_yaw,forces,moments,speed,time,mass,steps,anim_opts)
...
%         scaleS=0.05*anim_scale; % standard
        ...
        scaleS=0.0333333*anim_scale; % for Science figure 2, 1 m/s ~ 0.033 m
...
%         scaleF=0.4*anim_scale; % standard
        ...
        scaleF=1/(mass*9.81)*0.0666666*anim_scale; % for Science supplement pitch flip, 1g ~ 0.066 m
