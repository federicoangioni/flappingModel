...
function transformer_animation_simple(posx,posy,posz,roll,pitch,yaw,dihedrL,dihedrR,cmd_motor_left,cmd_motor_right,cmd_roll,cmd_pitch,cmd_yaw,cmd_thrust,forces,moments,speed,fL,fR,time,anim_opts)
