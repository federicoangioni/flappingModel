...
Nexp=36;
nman=1; % I only saved one maneuver in the Sceince dataset, it is number 5 in the original data
...
anim_lims=[-0.4 0.8 -1.2 0.25 -2 2];
step=round(fps*0.1);
...
%         saveas(gcf,['science_new_figures_fig2/' exp_title num2str(nn) '_exp' num2str(Nexp) '_INpitch' num2str(INpitch) '_LIMroll' num2str(LIMroll) '_OLroll' num2str(OLroll) '_OLpitch' num2str(OLpitch) '_sequence' num2str(nman) '.fig'])
%         saveas(gcf,['science_new_figures_fig2/' exp_title num2str(nn) '_exp' num2str(Nexp) '_INpitch' num2str(INpitch) '_LIMroll' num2str(LIMroll) '_OLroll' num2str(OLroll) '_OLpitch' num2str(OLpitch) '_sequence' num2str(nman) '.svg'])
%         saveas(gcf,['science_new_figures_fig2/' exp_title num2str(nn) '_exp' num2str(Nexp) '_INpitch' num2str(INpitch) '_LIMroll' num2str(LIMroll) '_OLroll' num2str(OLroll) '_OLpitch' num2str(OLpitch) '_sequence' num2str(nman) '.png'])

title('delete every second frame in the second part of the maneuver in the post processing')